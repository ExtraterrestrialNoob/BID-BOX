...
<div class="row">
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center experience"><span>Password Reset</span><span class="border px-3 p-1 add-experience"><a class="fa fa-plus" href="{{ route('password.request') }}"><button class="fa fa-plus">&nbsp;Password Reset</button></a></span></div><br>
            </div>
        </div>
    </div>
</div>
