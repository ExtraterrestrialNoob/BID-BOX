                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-5">
                                    <div class="filter__sort">
                                        ...
                                        <select id="sortBy" name="sortBy" onchange="this.form.submit();">
                                            ...
                                            <option value="lth" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'lth') selected @endif>Price -
                                                Lower To Heigher</option>
                                            <option value="htl"@if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'htl') selected @endif>Price -
                                                Heigher To Lower</option>
                                            <option value="acs"@if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'acs') selected @endif>
                                                Alphabetical Ascending</option>
                                            <option value="desc" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'desc') selected @endif>
                                                Alphabetical Descending</option>
                                            <option value="let" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'let') selected @endif>Leatest
                                            </option>
                                            <option value="old" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'odl') selected @endif>Oldest
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown col-lg-3 col-md-5 ">
                                    @if (!empty($_GET['category']))
                                        ...
                                        @endphp
                                    @endif
                                    <button class="btn btn-light dropdown-toggle" data-mdb-ripple-color="dark"
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    ...
                                                    <div class="form-check">
                                                        <input @if (!empty($filter_cats) && in_array($cat->slug, $filter_cats)) checked @endif
                                                            type="checkbox" class="form-check-input"
                                                            value="{{ $cat->slug }}" id="{{ $cat->id }}"
                                                            name="category[]" onchange="this.form.submit();" />
                                                        <label class="form-check-label"
                                                            for="{{ $cat->slug }}"><span></span>{{ ucfirst($cat->name) }}
                                ...
                                <div class="dropdown col-lg-3 col-md-5 ">
                                    <button class="btn btn-light dropdown-toggle" data-mdb-ripple-color="dark"
                                        type="button" data-toggle="dropdown">Price
                        ...
                        <div id='all_conatainer' class="main_container">
                            <div class="container">
                                ...
                                <div class="product__item mb-5">
                                    ...
                                    <div class="card_item">
                                        <div class="card_img">
                                            <img class="c-node_img_content" src="{{ asset('storage/' . $i->image_path) }}"
                                                alt="img_1">
                                        </div>
                                        <div class="card_details">
                                            <div class="card_details_title">
                                                <h3 class="card_details_tittle">
                                                    <a href="{{ route('product.view', $i->id) }}"> {{ $i->name }}
                                                    </a>
                                                </h3>
                                            </div>
                                            ...
                                            <div class="card_button">
                                                <a onclick="window.location.href='{{ route('product.view', $i->id) }}';">BID
                                                    NOW</a>
                                            </div>
                                        </div>
                                    </div>
