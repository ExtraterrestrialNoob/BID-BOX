        ...
        <div class="container">
            ...
            <div class="row flex-wrap-reverse">
                                    ...
                                    @foreach ($category as $cat)
                                        <div class="form-check form--check">
                                            <input type="checkbox" @if (!empty($filter_cats) && in_array($cat->slug, $filter_cats)) checked @endif
                                                class="form-check-input category-check" value="{{ $cat->slug }}"
                ...
                <div class="col-lg-8 col-xl-9 search-result">
                        ...
                        <div class="d-flex  justify-content-end" style="margin-bottom: 15px;">
                            <div class="input-group">
                                <div class="form-outline">
                                    <input type="search" id="search" name="query" class="form-control"
                    ...
                    <div class="d-flex flex-wrap justify-content-sm-between justify-content-center mb-3"
                        style="gap:15px 30px">
                        <p class="mb-0 text-white-50">Showing Results: <span>{{ count($all_products) }}</span></p>
                        <p class="mb-0 text-white-50">Results Found: <span>{{ $all_products->total() }}</span></p>
                    </div>
                    <div class="row">
                            ...
                            <div class="col-md-4 pb-1 pb-md-0 ">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('product.view', $i->id) }}" class="btn btn-primary">BID
                                            NOW</a>
                                    </div>
                                </div>
                            </div>
