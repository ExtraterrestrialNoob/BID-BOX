          ...
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <!-- <a href="https://sendgrid.com" target="_blank" style="display: inline-block;"> -->
                <img src="https://bid-box.epizy.com/assets/images/logoIcon/logo.png" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
              </a>
            </td>
          </tr>
        </table>
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  ...
                  <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>{{$data['win_id']}}</strong></td>
                </tr>
                <tr>
