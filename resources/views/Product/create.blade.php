...
@csrf
                        ...
                        <div class="row mb-3">
                            <label for="price" class="col-md-4 col-form-label text-md-end text-light">{{ __('Price') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="image" class="col-md-4 col-form-label text-md-end text-light">{{ __('Image ') }}</label>
