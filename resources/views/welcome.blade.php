                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        @else
                            <div class="header__top__right__language">
                                ...
                                <div class="fa-sharp fa-solid fa-circle-user fa-xl"></div> {{ Auth::user()->name }} 
                                <!-- </a> -->

                                <!-- <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown"> -->
                                <!-- <span class="arrow_carrot-down"></span> -->
                                    <ul>
                                        <li  href="{{route('user.user')}}" ><a> <i class="fa-sharp fa-solid fa-circle-user fa-xl"></i> Profile </a></li>
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{url('storage/assets/images/frontend/banner.jpg')}}" style="background-image: url('storage/assets/images/frontend/banner.jpg');">
