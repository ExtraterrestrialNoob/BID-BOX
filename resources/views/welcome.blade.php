            ...
            @for($i=0;$i<$count;$i++)
                <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top img-responsive" style="object-fit:cover; height:200px; width:100%; Overflow:hidden;" src="{{ asset('storage/assets/images/product/'.$all_products[$i]->image_path) }}"  />
                            <!-- Product details-->
