            ...
            @for($i=1;$i<=8;$i++)
                <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="{{ asset('assets/images/product/'.$all_products->image_path) }}"  />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                    Rs{{$all_products->price}}
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{route('product.view', $all_products->id )}}">View</a></div>
                            </div>
                        </div>
                    </div>
            @endfor
